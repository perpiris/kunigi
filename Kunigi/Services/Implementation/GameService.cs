...
//         teamList.Insert(0, new Team { TeamId = default, Name = "Επιλογή Ομάδας" });
//
...
//     }
//
//     public async Task<PuzzleCreateViewModel> PrepareCreateGamePuzzleViewModel(Guid parentGameId, ClaimsPrincipal user)
//     {
//         await CanEditParentGame(parentGameId, user);
//         
//         var gameDetails = await _context.Games
...
//     }
//
//     public async Task CreateGamePuzzle(PuzzleCreateViewModel viewModel, ClaimsPrincipal user)
//     {
//         var gameDetails = await _context.Games
//             .Include(x => x.ParentGame)
//             .Include(x => x.PuzzleList)
...
//     }
//
//     public async Task<PuzzleEditViewModel> PrepareEditGamePuzzleViewModel(Guid puzzleId, ClaimsPrincipal user)
//     {
...
//     }
//
//     public async Task EditGamePuzzle(PuzzleEditViewModel viewModel)
//     {
//         var puzzleDetails = await _context.Puzzles
//             .Include(x => x.Game)
...
//     }
//
//     public async Task DeleteGamePuzzle(Guid puzzleId)
//     {
...
//     }
//
//     public async Task DeleteGamePuzzleMedia(Guid puzzleId, Guid mediaId, ClaimsPrincipal user)
//     {
...
//     }
//     
//     private async Task CanEditPuzzle(Guid gameId, ClaimsPrincipal user)
//     {
//         ArgumentNullException.ThrowIfNull(gameId);
//         ArgumentNullException.ThrowIfNull(user);
//
